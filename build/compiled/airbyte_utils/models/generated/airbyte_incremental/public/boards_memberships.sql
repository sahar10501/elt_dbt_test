...
),  __dbt__cte__boards_memberships_ab3 as (
...
-- depends_on: __dbt__cte__boards_memberships_ab3
select
    _airbyte_boards_hashid,
    "id",
    idmember,
...
from __dbt__cte__boards_memberships_ab3
-- memberships at boards/memberships from "bzr_etl_task".public."boards"
where 1 = 1
